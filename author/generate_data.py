...
def get_data_synthetic(data_cluster_locations=[0, 45, 80, 100, 135, 180, -135, -100, -80, -45], 
...
def get_data_synthetic_downstream_test(data_cluster_locations=[0, 45, 80, 100, 135, 180, -135, -100, -80, -45], 
...
def plot_hypersphere_2D(data_x, data_y, data_o, title_txt="", data_path=None, marker_size=500, fig_size=(7, 7)):
    ...
    if data_path is None:
        ...
        plt.scatter(lo_risk_terminal_0[:, 0], lo_risk_terminal_0[:, 1], color='darkgreen', s=marker_size, label='X[2] / Lung / Negative', marker="^", edgecolors='black')
        plt.scatter(hi_risk_terminal_0[:, 0], hi_risk_terminal_0[:, 1], color='darkred', s=marker_size*0.8, label='X[2] / Lung / Positive', marker="^", edgecolors='black')
        plt.scatter(lo_risk_terminal_1[:, 0], lo_risk_terminal_1[:, 1], color='darkgreen', s=marker_size, label='X[2] / Heart / Negative', marker="o", edgecolors='black')
        plt.scatter(hi_risk_terminal_1[:, 0], hi_risk_terminal_1[:, 1], color='darkred', s=marker_size*0.8, label='X[2] / Heart / Positive', marker="o", edgecolors='black')
        
        plt.scatter(lo_risk_non_terminal_0[:, 0], lo_risk_non_terminal_0[:, 1], color='limegreen', s=marker_size, label='X[1] / Lung / Negative', marker="^", edgecolors='black')
        plt.scatter(hi_risk_non_terminal_0[:, 0], hi_risk_non_terminal_0[:, 1], color='red', s=marker_size*0.8, label='X[1] / Lung / Positive', marker="^", edgecolors='black')
        plt.scatter(lo_risk_non_terminal_1[:, 0], lo_risk_non_terminal_1[:, 1], color='limegreen', s=marker_size, label='X[1] / Heart / Negative', marker="o", edgecolors='black')
        plt.scatter(hi_risk_non_terminal_1[:, 0], hi_risk_non_terminal_1[:, 1], color='red', s=marker_size*0.8, label='X[1] / Heart / Positive', marker="o", edgecolors='black')
        
        plt.scatter(lo_risk_start_0[:, 0], lo_risk_start_0[:, 1], color='lightgreen', s=marker_size, label='X[0] / Lung / Negative', marker="^", edgecolors='black')
        plt.scatter(hi_risk_start_0[:, 0], hi_risk_start_0[:, 1], color='lightcoral', s=marker_size*0.8, label='X[0] / Lung / Positive', marker="^", edgecolors='black')
        plt.scatter(lo_risk_start_1[:, 0], lo_risk_start_1[:, 1], color='lightgreen', s=marker_size, label='X[0] / Heart / Negative', marker="o", edgecolors='black')
        plt.scatter(hi_risk_start_1[:, 0], hi_risk_start_1[:, 1], color='lightcoral', s=marker_size*0.8, label='X[0] / Heart / Positive', marker="o", edgecolors='black')
